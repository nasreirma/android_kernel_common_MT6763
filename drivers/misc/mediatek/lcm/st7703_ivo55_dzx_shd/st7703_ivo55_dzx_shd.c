...
static struct LCM_setting_table lcm_initialization_setting[] =
{
  ...
  // Set DSI
  {0xba, 27,{0x32,0x81,0x05,0xf9,0x0C,0x0C,0x20,0x00,0x00,0x00,
              0x00,0x00,0x00,0x00,0x44,0x25,0x00,0x91,0x0a,0x00,
              0x00,0x02,0x4f,0x01,0x00,0x00,0x37}},//7th 02->20
  //ECP
  {0xb8, 4,{0x26,0x22,0x20,0x03}},//1st 25->26 harvey170926
  //SET RGB
  {0xb3, 10,{0x10,0x10,0x05,0x05,0x03,0xff,0x00,0x00,0x00,0x00}},
  //SCR
  {0xc0, 9,{0x70,0x73,0x50,0x50,0xC0,0xC0,0x08,0x70,0x00}},//5&6th 00,00
  //ECO
  //{0xc6, 6,{0x00,0x00,0xFF,0xFF,0x00,0x20}},
  {0xc6, 6,{0x02,0x00,0xFF,0xFF,0x00,0x20}},//1st 00->02 harvey170926
  //Set VDC
  {0xbc, 1,{0x4e}},
  //Set OSC
  {0xcb, 1,{0x02}},//1st 03->02 harvey170926
  //Set Panel
  {0xcc, 1,{0x0b}},//0b
  //Set Panel inversion
  {0xb4, 1,{0x80}},
  ...
  // Set EQ
  {0xe3, 14,{0x07,0x07,0x0b,0x0b,0x10,0x10,0x00,0x00,0x00,0x00,
              0xff,0x00,0xc0,0x10}},
  //Set POWER
  {0xc1, 12,{0x54,0x00,0x1e,0x1e,0x99,0xC1,0xff,0xff,0xee,0xee,0xee,0xee}},//6th F1->C1 harvey170926
  //Set POWER
  {0xb5, 2,{0x07,0x07}},
  //Set VCOM
  {0xb6, 2,{0x1C,0x1C}},//33
  ...
  //GIP
  {0xe9, 63,{0xC2,0x10,0x06,0x05,0x00,0x0a,0x80,0x12,0x31,0x23,
              0x37,0x83,0x04,0x80,0x27,0x38,0x0c,0x00,0x03,0x00,
              ...
              0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}},//7&14th a0,bc->80,80
  //GIP
  {0xea, 61,{0x02,0x21,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
              ...
              0x88,0x88,0x75,0x88,0x23,0x20,0x00,0x00,0x30,0x00,
              0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
              0x00,0x00,0x00,0x00,0x30,0x0a,0x80,0x00,0x00,0x00,0x00}},//36th 10->20 harvey170926 57th a0->80
  //Set Gamma
  {0xe0, 34,{0x00,0x0B,0x12,0x2d,0x3e,0x3f,0x49,0x3C,0x06,0x0d,0x0E,0x12,0x13,0x10,0x12,0x11,0x19,
              0x00,0x0B,0x12,0x2d,0x3e,0x3f,0x49,0x3C,0x06,0x0d,0x0E,0x12,0x13,0x10,0x12,0x11,0x19}},
...
#if defined(BUILD_LK)
  printf("st7703_ivo55_dzx_shd %s,line=%d, id = 0x%x, buffer[0]=0x%08x,buffer[1]=0x%08x\n",__func__,__LINE__, device_id, buffer[0],buffer[1]);
#else
  printk("st7703_ivo55_dzx_shd %s,line=%d, id = 0x%x, buffer[0]=0x%08x,buffer[1]=0x%08x\n",__func__,__LINE__, device_id, buffer[0],buffer[1]);
#endif
...
LCM_DRIVER st7703_ivo55_dzx_shd_lcm_drv =
{
  .name			  = "st7703_ivo55_dzx_shd",
