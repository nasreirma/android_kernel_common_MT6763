...
static void lcm_get_params(LCM_PARAMS *params)
{
  ...
  params->dsi.horizontal_backporch				= 90; //100;60;
  params->dsi.horizontal_frontporch				= 90; //70;60;
  params->dsi.horizontal_active_pixel				= FRAME_WIDTH;


  params->dsi.PLL_CLOCK = 247; //244; //245; //258;//244;260;258;256;262;264;262;256;
...
// ---------------------------------------------------------------------------
LCM_DRIVER jd9365d_hsd585_hongzhan_llhd_lcm_drv = 
{
  .name          = "jd9365d_hsd585_hongzhan_llhd",
