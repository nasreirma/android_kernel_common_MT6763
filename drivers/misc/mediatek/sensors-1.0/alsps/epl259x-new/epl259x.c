...
int epl_sensor_setup_eint(struct i2c_client *client)
{
    ...
    if (IS_ERR(pins_cfg)) {
        ...
        printk("pinctrl_lookup_state ok!!\n");
    }
#endif
	if (obj->irq_node)
	{
...
#if ANDR_M
//  yuting  obj->irq_node = of_find_compatible_node(NULL, NULL, "mediatek, ALS-eint");
#endif /*ANDR_M*/
    obj->irq_node = client->dev.of_node;//yuting
