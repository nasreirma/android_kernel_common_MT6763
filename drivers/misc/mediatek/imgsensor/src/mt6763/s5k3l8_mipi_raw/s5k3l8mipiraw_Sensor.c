...
//for 3l8
{
	...
	.i4PosL = {
				//{31,28},{83,28},{47,32},{67,32},{35,40},{79,40},{51,44},{63,44},{51,60},{63,60},{35,64},{79,64},{47,72},{67,72},{31,76},{83,76}
				{28,31},
				{80,31},
				{44,35},
				{64,35},
	...
	.i4PosR = {
		//{31,24},{83,24},{47,28},{67,28},{35,44},{79,44},{51,48},{63,48},{51,56},{63,56},{35,60},{79,60},{47,76},{67,76},{31,80},{83,80}
				{28,35},
				{80,35},
				{44,39},
				{64,39},
...
{
	LOG_INF("E! capture_setting lpl currefps:%d\n",currefps);
	if (currefps == 300) {
