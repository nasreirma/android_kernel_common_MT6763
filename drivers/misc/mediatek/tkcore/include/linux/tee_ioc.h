...
#define TEE_TUI_OPEN_SESSION_IOC		_IOWR('t', 168, struct tee_cmd_io)
#define TEE_TUI_CLOSE_SESSION_IOC		_IOWR('t', 169, struct tee_cmd_io)
#define TEE_TUI_NOTIFY_IOC 				_IOWR('t', 170, uint32_t)
#define TEE_TUI_WAITCMD_IOC 			_IOWR('t', 171, uint32_t)

#define TEE_INSTALL_SYSTEM_TRUSTED_APP	_IOW('t', 180, struct tee_ta_inst_desc)
