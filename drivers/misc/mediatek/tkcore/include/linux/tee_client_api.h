...
/*
	TEEC_MEM_NONSECURE	Memory is allocated by linux memory allocator,
	instead of the reserved pool. The allocated memory
	is not necessarily contiguous in the physical
	address*/
