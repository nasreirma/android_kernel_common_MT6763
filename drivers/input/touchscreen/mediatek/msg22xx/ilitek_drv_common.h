...
#define DEVICE_DRIVER_RELEASE_VERSION   ("8.0.0.0")
 ...
 */
#define TOUCH_SCREEN_X_MAX   CFG_TPD_WIDTH    //(480)  //LCD_WIDTH
#define TOUCH_SCREEN_Y_MAX   CFG_TPD_HEIGHT  //(960) //LCD_HEIGHT
/*
 * Note.
